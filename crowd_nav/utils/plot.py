...
def main():
    ...
    for i, log_file in enumerate(args.log_files):
        ...
        if args.plot_sr:
            if ax1 is None:
                _, ax1 = plt.subplots(figsize=(12,8), dpi=300)
            if args.plot_train:
        ...
        if args.plot_time:
            if ax2 is None:
                _, ax2 = plt.subplots(figsize=(12,8), dpi=300)
            if args.plot_train:
        ...
        if args.plot_cr:
            if ax3 is None:
                _, ax3 = plt.subplots(figsize=(12,8), dpi=300)
            if args.plot_train:
        ...
        if args.plot_reward:
            if ax4 is None:
                _, ax4 = plt.subplots(figsize=(12,8), dpi=300)
            if args.plot_train:
